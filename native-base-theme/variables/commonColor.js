...
export default {
  ...
  // Color
  brandPrimary: platform === PLATFORM.IOS ? '#007aff' : '#383839',
  brandInfo: '#62B1F6',
  brandSuccess: '#5cb85c',
  brandDanger: '#d9534f',
  brandWarning: '#f0ad4e',
  ...
  // Font
  DefaultFontSize: 16,
  fontFamily: platform === PLATFORM.IOS ? 'System' : 'Roboto', //'monospace',
  fontSizeBase: 15,
  get fontSizeH1() {
  ...
  tabActiveBgColor: platform === PLATFORM.IOS ? '#cde1f9' : '#383839',

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  toolbarDefaultBg: platform === PLATFORM.IOS ? '#383839' : '#383839',
  ...
  toolbarDefaultBorder: platform === PLATFORM.IOS ? '#a7a6ab' : '#383839',
  get statusBarColor() {
  ...
  listNoteSize: 13,
  listItemSelected: platform === PLATFORM.IOS ? '#007aff' : '#383839',
  ...
  radioSelectedColorAndroid: '#383839',
  ...
  // Segment
  segmentBackgroundColor: platform === PLATFORM.IOS ? '#383839' : '#383839',
  segmentActiveBackgroundColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  segmentTextColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  segmentActiveTextColor: platform === PLATFORM.IOS ? '#fff' : '#383839',
  segmentBorderColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  segmentBorderColorMain: platform === PLATFORM.IOS ? '#a7a6ab' : '#383839',
  ...
  // Tab
  tabDefaultBg: platform === PLATFORM.IOS ? '#383839' : '#383839',
